...
contract Secp256r1_new {
    ...
    */
    function Verify(uint256 X, uint256 Y, uint256 r, uint256 s, bytes32 input)
    ...
    */
    ...
    function Add(uint256 p1, uint256 p2, uint256 q1, uint256 q2)
        public pure returns(uint256, uint256)
    {
        uint256 p3;
    ...
    function Double(uint256 p1, uint256 p2)
        public pure returns(uint256, uint256)
    {
        uint256 p3;
    ...
    */
    function _jDouble(uint256 p1, uint256 p2, uint256 p3)
        public pure returns(uint256 q1, uint256 q2, uint256 q3)
    {
        assembly {
    ...
    */
    function _invmod(uint256 value, uint256 p)
