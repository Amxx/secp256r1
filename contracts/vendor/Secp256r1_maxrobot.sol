...
library Secp256r1_maxrobot {
    ...
    /*
    * Verify
    * @description - verifies that a internal key has signed a given message
    * @param X - internal key coordinate X
    * @param Y - internal key coordinate Y
    * @param R - signature half R
    * @param S - signature half S
    * @param uinte - hashed message
    */
    function Verify(uint256 X, uint256 Y, uint256[2] memory rs, uint256 e) internal pure returns (bool) {
        if (rs[0] >= nn || rs[1] >= nn) {
            return false;
        }
    ...
    */
    ...
    function Double(uint256 p1, uint256 p2) internal pure returns (uint256, uint256) {
        uint256 p3;
    ...
    */
    function ScalarMult(uint256 Bx, uint256 By, bytes memory k) internal pure returns (uint256, uint256) {
        unchecked {
            uint256 Bz = 1;
            uint256 x = 0;
            uint256 y = 0;
    ...
    * crypto/elliptic library
    */
    function ScalarBaseMult(bytes memory k) internal pure returns (uint256, uint256) {
    ...
    */
    function _affineFromJacobian(uint256 x, uint256 y, uint256 z) internal pure returns (uint256 ax, uint256 ay) {
        if (z == 0) {
            return (0, 0);
        }
    ...
    */
    function _jDouble(uint256 p1, uint256 p2, uint256 p3) internal pure returns (uint256 q1, uint256 q2, uint256 q3) {
        assembly {
            let pd := 0xFFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFF
    ...
    function _hashToUint(bytes memory input) internal pure returns (uint256) {
    ...
    */
    function _invmod(uint256 value, uint256 p) internal pure returns (uint256) {
        unchecked {
