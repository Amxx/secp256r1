...
library P256 {
    ...
    function getPublicKey(uint256 privateKey) internal pure returns (uint256, uint256) {
    ...
    function scalarMult(uint256 Bx, uint256 By, uint256 k) internal pure returns (uint256, uint256) {
        uint256 x = 0;
        uint256 y = 0;
        uint256 z = 0;
     ...
     */
    function _affineFromJacobian(uint256 x, uint256 y, uint256 z) private pure returns(uint256 ax, uint256 ay) {
        if (z == 0) return (0, 0);
